...
$(function () {
  ...
  $('.work-video').on('click', function (event) { // When arrow is clicked

    let videoUrl = $(this).attr("data-href");
    let video_ViewType = $(this).attr("data-view");



    if (video_ViewType === "vertical") {
